class Data():
    def __init__(self):
        ...
        'Nervous eyes movement', 'Distinctive nose', 'Different posture (crooked or rigid)', 'Exceptionally beautiful', 'Exceptionally ugly', 'A long, glorious beard. Each braid represents another person that has asked him what the braids mean.',
        'The npc has a cleft cut into their nose.', 'The npc has many tiny tattoos across their face starting from the corner of their mouth to the edge of their eye.',
        'The npc has an extra hand coming out of their right arm the hand is as small as a child’s and is blackened and seems to be of no use.', 'The NPC is missing a tooth.',
        'One of the NPC’s arms is a different tone, length, and has a different shape of hand than the other.', 'The NPC has been cursed to have a part of their body, (arm, leg, hand, maybe even a tail…) that is of a different race. (ex. A human with the hand of a tabaxi…)',
        'The NPC has many scars and callouses along their forearms, perhaps being formed over many brutal sparring sessions.', 'The NPC has long, slender fingers, perhaps from living an easy life in the high class or perhaps from living a life scrounging in the streets.'
        ...
        'NPC doesn’t have eyebrows, but instead has tattooed eyebrows slightly too high, which gives a look of permanent surprise.', 'PC is covered in tattoos of the cities they have been to. Each one best representing that city.',
        ...
        'NPC has a horn coming out of their forehead that they are very self conscious about. They constantly shave it off if they have time.', 'NPC has scales on his legs. (If they are a species that usually has scales then their legs are human.)',
        'NPC has no natural teeth left. Luckily for him his enemies had some of theres. His jaw is full of random teeth that are surgically placed in. They may not be fabulous but they sure is scary!', 'NPC has a magical tattoo that can answer riddles.',
        'NPC is missing his left eye. He constantly forgets which eye is actually gone.', 'NPC has acid burn scars on both of his hands.', 'NPC is fascinated by jewelry so much so that they are wearing so much jewelry that it weighs them down.', 
        ...
        'NPC has a extremely chapped li ps.', 'NPC has a tattoo of a map leading to an X. Doesn’t remember when it got there or why it’s there.', 'NPC has a mechanical limb that they cannot fully control. It does the motion for whatever he is thinking even if it’s socially wrong.',
        ...
        'The NPC has not cut or groomed his/her hair since he/she was defeated by his/her rival 8 years ago.', 'Scars… Everywhere.', 'The NPC has a beard that is visibly fake.', 'The NPC has an eye on the palm of his/her right hand that he/she tries to hide with a fingerless glove.',
        ...
        'NPC has a Hunchback and disfigured face with extra growths.', 'NPC has whats left of a hand still attached. It looks like it was crushed and was never amputated.', 'NPC has abnormally large forearms and/or calves.', 'The NPC is wearing an obvious wig.',
        ...
        'NPC is blind/deaf.', 'NPC has ashen skin and no hair.', 'NPC has sharpened teeth and loves to smile.', 'NPC is unusually hairy, having thick hair on almost all visible skin apart from around eyes and palms.', 'NPC always wears bright, vibrant clothing.',
